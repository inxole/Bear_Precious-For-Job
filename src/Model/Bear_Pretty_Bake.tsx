...
Command: npx gltfjsx@6.2.13 .\Bear_Pretty_Bake.gltf -t 
*/
...
const Bear_Precious_Baked = (props: JSX.IntrinsicElements['group']) => {
  const group = useRef<THREE.Group>(null)
  const { nodes, materials, animations } = useGLTF('/Bear_Pretty_Bake.gltf') as GLTFResult
...
export default Bear_Precious_Baked
useGLTF.preload('/Bear_Pretty_Bake.gltf')
